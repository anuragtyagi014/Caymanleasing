...
.pending_car.sold_car {
    background-image: url(https://www.caymanleasing.com/wp-content/themes/caymanleasing/images/sold.png);
    position: absolute;
    top: 0;
    height: 168px;
    width: 224px;
...
<section class="cars-gallery cars_gallery">
    <div class="container">
        <div class="row">
            <div class="heading">
                <a href="javascript:;" class="inventory__btn" onclick="showhide()">Inventory</a>
            </div>
		</div>
	</div>
</section>
                                ...
                                <ul>
	                                ...
	                                <?php if ( get_field('buy') ): ?>
                                        ...
                                        <li>
                                            ...
                                            <p <?php if($price_color){}else{ ?> class="price-color" <?php } ?>><strong><?php echo get_post_meta($post->ID, 'buy', true); ?></strong></p>
                                        </li>
...
<section class="faq-area" id="faq-area">
	<div class="container">
    	<div class="row">
		    ...
		    $chunked_posts = array_chunk( $custom_query, 7 ); 
...
<section class="resource-area-sec" id="resourcearea">
    <div class="container">
        <div class="leasing-heaidng"><h4>Resources</h4></div>
            <div class="resource text-center" id="resource">
                <div class="row">
                    <div class="col-sm-3 resource-pad resource-btn-custom">
                    <a  href="https://www.caymanleasing.com/wp-content/uploads/2020/10/Form20-20New20Client20Application.pdf" target="_blank" class="btn btn-primary btn-resource">New Client Application Form</a>
                    </div>
                    <div class="col-sm-3 resource-pad resource-btn-custom">
                      <a  href="https://www.caymanleasing.com/wp-content/uploads/2020/10/Form20-20Sample20Contract.pdf" target="_blank" class="btn btn-primary btn-resource">Sample Contract Form</a>
                    </div>
                    <div class="col-sm-3 resource-pad resource-btn-custom">
                      <a  href="https://www.caymanleasing.com/wp-content/uploads/2020/10/Form-BritCay-Quote-1.pdf" target="_blank" class="btn btn-primary btn-resource">Britcay Quote Form</a>
                    </div>
                    <div class="col-sm-3 resource-pad resource-btn-custom">
                      <a  href="https://www.caymanleasing.com/wp-content/uploads/2020/10/Form-Cash-Deposit-Information-1.pdf" target="_blank" class="btn btn-primary btn-resource">Cash Deposit Form</a>
                    </div>
...
<section class="upload-doc-sec" id="upload-doc-sec">
    <div class="container">
        <div class="leasing-heaidng"><h4>Upload Document</h4></div>
		<div class="upload-form">
			<?php echo do_shortcode( '[contact-form-7 id="11034" title="Upload Document"]' ); ?>
		</div>
	</div>
</section>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="contact-detail-item">
                        ...
                        <p>Phone Number <a href="tel:345-945-2211">345-945-2211</a></p>
                    </div>
                </div>
                <!-- <div class="col-sm-3">
                    <div class="contact-detail-item">
                ...
                <div class="col-sm-4">
                    <div class="contact-detail-item">
                        ...
                        <p>Address <a href="https://goo.gl/maps/9rBRJHavpnumnu1n8" target="_blank">70 Hospital Road,<br /> George Town</a></p>
                    </div>
                </div>
            </div>
        </div>
