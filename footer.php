...
<script type="text/javascript">
    ...
    jQuery("#leaseend_date").datepicker({
        minDate: new Date('<?php echo date('Y', strtotime('+1 month')) . '/' . date('m', strtotime('+1 month')) . '/02'; ?>')
    });
</script>
<script type="text/javascript">
    new WOW().init();
